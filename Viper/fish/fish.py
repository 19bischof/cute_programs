...
rows = []
try:
    csv_file_handle = open(project_path+"/fish.csv", encoding="utf-8")
...
# what has been selected (the chosen pattern)
...
while True:
    ...
    # list of dicts, one dict per page, one key for each option
